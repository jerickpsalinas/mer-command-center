  ...
  return (
    <div ref={dashRef} className="space-y-6 sm:space-y-7">
      ...
      <section className="space-y-3">
        <div className="flex items-center justify-between gap-3 flex-wrap">
          ...
          <span className="inline-flex items-center gap-1.5 rounded-full border border-border bg-card px-2.5 py-1 text-[11px] text-muted-foreground">
            ...
            Pending MER
            <span className="font-mono-data text-foreground">{kpi.pendingMer}</span>
          </span>
        </div>
      ...
      <section className="space-y-3">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
          <KPICard title="Completion %" value={`${kpi.avgCompletion}%`} icon={TrendingUp} index={0}
            delta={deltaCompletion} deltaLabel={deltaLabel} />
          <KPICard title="Not Reconciled" value={kpi.notReconciled} icon={AlertTriangle} variant="destructive" index={1} />
          <KPICard title="Outstanding Stmts" value={kpi.outstandingStatements} icon={FileText} variant="warning" index={2} />
          <KPICard title="No Updated Notes" value={kpi.withoutNotes} icon={StickyNote} variant="destructive" index={3} />
        </div>
      </section>
